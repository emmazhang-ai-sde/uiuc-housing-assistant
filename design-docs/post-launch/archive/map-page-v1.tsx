...
export default function MapPage() {
  ...
  const { theme, presets, applyPreset, setColors, setGrain, reset } = useMapTheme()
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      {/* Left column: filter bar with the color picker docked beneath it */}
      <div className="absolute top-4 left-4 z-20 flex flex-col items-start gap-3">
        <MapFilterBar filters={filters} onChange={setFilters} className="" />
        <MapColorPicker
          theme={theme}
          presets={presets}
